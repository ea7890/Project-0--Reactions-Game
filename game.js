...
var makeTiger = function(){
    var tigerTime = Math.random();
    tigerTime=tigerTime*10000; //tiger appears at random time
...
document.getElementById("box1").onclick=function() {
    ...
    alert("Game Over! You got eaten by the Evil Tiger")
}

var hideTiger = function () {
    setTimeout(function() {
